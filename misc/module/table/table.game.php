...
class GameState {
    ...
    public function getPlayerActiveThisTurn() {
        $state = $this->state();
        return isset($state['active_player']) ? $state['active_player'] : $this->active_player;
    }
    ...
    public function getActivePlayerList() {
        ...
        if ($state['type'] == 'activeplayer') {
            ...
            return isset($state['multiactive']) ? $state['multiactive'] : [];
        } else
            return [];
    }
    ...
    function getPrivateState($playerId) {
        return isset($this->private_states[$playerId]) ? $this->private_states[$playerId] : null;
    }
